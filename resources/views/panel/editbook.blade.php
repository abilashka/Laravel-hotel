...
<div class="col-sm-12 col-md-4">
  <form class="reservation-vertical clearfix" role="form" action="/editbooking/{{$booking->id}}" name="reservationform" id="reservationform" method="POST">
    <h2 class="lined-heading"><span>Reservation</span></h2>
    <div class="price">
      <!-- <h4>{{$booking->Fcode}}</h4> -->
      &pound; {{$booking->Price}}-<span> a night</span></div>
    <div id="message"></div>
    ...
    <div class="form-group">
      ...
      <div class="popover-icon" data-container="body" data-toggle="popover" data-trigger="hover" value = "{{$booking->Checkout}}" data-placement="right" data-content="Check-out is from 12:00"> <i class="fa fa-info-circle fa-lg"> </i> </div>
      <i class="fa fa-calendar infield"></i>
